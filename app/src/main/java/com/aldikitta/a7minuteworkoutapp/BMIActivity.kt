...
import com.aldikitta.a7minuteworkoutapp.databinding.ActivityBmiactivityBinding
...
class BMIActivity : AppCompatActivity() {
    ...
    private fun displayBMIResult(bmi: Float) {
        ...
        if (bmi.compareTo(15f) <= 0) {
            ...
            bmiDescription = "You need to take better care of yourself, eat more nutrition"
            ...
            bmiLabel = "Overweight"
            bmiDescription = "You need to take better care of yourself, do diet and workout"
        } else if (bmi.compareTo(30f) > 0 && bmi.compareTo(35f) <= 0) {
            bmiLabel = "Obese class I (Moderately obese)"
            bmiDescription = "You need to take better care of yourself, do diet and workout"
        } else if (bmi.compareTo(35f) > 0 && bmi.compareTo(40f) <= 0) {
            bmiLabel = "Obese class II (Severely obese)"
            bmiDescription = "You are in very unhealthy condition, Act now!"
        } else {
